...
void Drive() 
{
  ...
  else
  {
    ...
    Left_motor.spin(directionType::rev, Controller1.Axis3.value(), velocityUnits::pct);
    Right_motor.spin(directionType::fwd, Controller1.Axis2.value(), velocityUnits::pct);
  }
}
